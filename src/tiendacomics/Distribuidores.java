...
public class Distribuidores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Nuevo, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 70, 70, -1));
        ...
        getContentPane().add(Volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 80, 90, -1));
    ...
    private void InsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InsertarActionPerformed
        try {
            ...
            if (Id.getText().length() == 0) {
                ...
                String query = "insert into Distribuidores values ('" + vId + "','" + vNombre + "','" + vPais + "')";
                int resultado = s.executeUpdate(query);
                String query2 = "select * from Distribuidores";
    ...
    private void NuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NuevoActionPerformed
        JOptionPane.showMessageDialog(null, "Vas a registrar un nuevo Distribuidor. Pulsa Aceptar para continuar.");
